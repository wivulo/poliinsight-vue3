export default {
    ...
    thead: ({ context }) => ({
        class: [
            {
                'bg-primary-500 top-0 z-40 sticky': context.scrollable
            }
        ]
    }),
    ...
    column: {
        headercell: ({ context, props }) => ({
            class: [
                ...
                // Color
                (props.sortable === '' || props.sortable) && context.sorted ? 'bg-primary-50 text-primary-700' : 'bg-primary-500 text-white',
    ...
    bodyrow: ({ context, props }) => ({
        class: [
            // Color
            'dark:text-white/80',
            { 'bg-primary-50/20 text-black dark:bg-primary-400/30': context.selected },
