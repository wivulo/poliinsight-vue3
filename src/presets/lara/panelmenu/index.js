export default {
    ...
    headercontent: ({ context, instance }) => ({
        class: [
            ...
            // Color
            'border-none border-surface-200 dark:border-surface-700',
    ...
    menuitem: {
        class: [
            ...
            'my-2 py-2 pl-5 rounded-sm',

            // Color
            'text-surface-700 dark:text-white/80',
            'hover:bg-surface-300 dark:hover:bg-surface-700/80',
