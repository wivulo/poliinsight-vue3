export default {
    root: ({ props, context, parent }) => ({
        class: [
            ...
            // States
            {
                'hover:border-zinc-400 dark:hover:border-primary-400': !context.disabled && !props.invalid,
                ...
                'focus:outline-none focus:outline-offset-0 focus:border-zinc-500 focus:z-10': !context.disabled,
