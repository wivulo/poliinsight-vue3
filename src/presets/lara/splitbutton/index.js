    ...
    button: {
        root: ({ parent }) => ({
            class: [
                ...
                'leading-[normal]',
                {
                    'px-2 py-1': parent.props.size === null,
                    'text-sm': parent.props.size === 'small',
                    'text-xl py-3 px-4': parent.props.size === 'large'
                },
                {
                    'min-w-12 p-0 py-1': parent.props.label == null && parent.props.icon !== null
                },
        ...
        root: ({ parent }) => ({
            class: [
                ...
                'leading-[normal]',
                {
                    ...
                    'text-sm py-1 px-3': parent.props.size === 'small',
                    'text-xl py-3 px-4': parent.props.size === 'large'
                },
                {
                    'min-w-12 p-0 py-1': parent.props.label == null && parent.props.icon !== null
