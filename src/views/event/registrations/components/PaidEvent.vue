...
<template>
    <div class="flex flex-col gap-3 mt-4 mb-2 text-sm" v-if="event?.type === 'paid'">
        ...
        <div class="flex flex-col gap-2">
            <Dropdown id="payment" v-model="registration.payment_mode" :options="payment_modes" optionLabel="label" optionValue="value" placeholder="Selecione um método de pagamento" class="h-9 w-full">
